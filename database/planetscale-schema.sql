-- BDS PRO Database Schema for PlanetScale (MySQL)
-- This schema is optimized for PlanetScale's MySQL-compatible database

-- Create database (if not exists)
-- Note: In PlanetScale, the database is already created, so this is for reference
-- CREATE DATABASE IF NOT EXISTS `bds-pro-db`;
-- USE `bds-pro-db`;
